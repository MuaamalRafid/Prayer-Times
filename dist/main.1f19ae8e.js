...
function getPrayerTimesByCity(city) {
  _axios.default.get("http://api.aladhan.com/v1/timingsByCity?city=".concat(city, "&country=iraq")).then(function (response) {
    ...
    document.getElementById("dhuhr").innerHTML = response.data.data.timings.Dhuhr;
...
function selectCity() {
  ...
  for (var _i = 0, _cities = cities; _i < _cities.length; _i++) {
    var city = _cities[_i];
    var content = "\n<option value =\"".concat(city.code, "\">").concat(city.name, "</option>\n        ");
  ...
  document.getElementById("city").addEventListener("change", function (e) {
    ...
    var cityName = "";
    for (var _i2 = 0, _cities2 = cities; _i2 < _cities2.length; _i2++) {
      var _city = _cities2[_i2];
      if (_city.code === e.target.value) {
        cityName = _city.name;
      }
    }
